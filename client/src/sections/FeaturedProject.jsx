...
const FeaturedProject = () => {
  return (
    <section className="relative z-10 mt-0 mb-0 w-full bg-linear-to-b from-[#0a0d1f] to-[#060812] px-4 pb-12 pt-10 md:px-8 min-[768px]:max-[1199px]:pb-12 min-[768px]:max-[1199px]:pt-8 min-[1200px]:max-[1399px]:min-h-[70vh] min-[1200px]:max-[1399px]:pb-14 min-[1200px]:max-[1399px]:pt-10 min-[1400px]:min-h-screen min-[1400px]:pb-28 min-[1400px]:pt-14">

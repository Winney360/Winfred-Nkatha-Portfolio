  ...
  return (
    <section className="relative z-10 mt-0 mb-0 w-full bg-black px-4 pb-12 pt-10 md:px-8 min-[768px]:max-[1199px]:pb-12 min-[768px]:max-[1199px]:pt-8 min-[1200px]:max-[1399px]:min-h-[70vh] min-[1200px]:max-[1399px]:pb-14 min-[1200px]:max-[1399px]:pt-10 min-[1400px]:min-h-screen min-[1400px]:pb-28 min-[1400px]:pt-14">
      ...
      <motion.div
        ...
        className="relative mx-auto w-full max-w-7xl rounded-2xl overflow-hidden border border-emerald-400/30 bg-linear-to-b from-[#06120a] to-[#020805] shadow-2xl md:ml-4"
      >
        <div className="pointer-events-none absolute inset-x-0 top-0 h-28 bg-linear-to-b from-emerald-400/25 via-emerald-400/10 to-transparent blur-2xl" />

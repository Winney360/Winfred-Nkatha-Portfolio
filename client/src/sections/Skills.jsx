...
const Skills = () => {
  return (
    <section className="relative overflow-hidden bg-black px-8 py-20" id="skills">
      ...
      >
        <h2 className="mb-8 text-center text-4xl font-bold text-white">Skills</h2>
        ...
        <div className="grid items-start gap-10 lg:grid-cols-[minmax(0,1fr)_360px] lg:items-center lg:gap-4">
                ...
                <div className="flex flex-wrap gap-10">
                  {items.map((skill) => {
                    ...
                    return (
                      <div
                        key={skill.name}
                        className="group flex h-30 w-30 flex-col items-center justify-center rounded-xl border border-violet-300/20 bg-[#221238]/72 p-2 shadow-lg shadow-black/25 backdrop-blur-sm transition-transform duration-300 hover:-translate-y-0.5"
                      >
                        {skill.isImage ? (
          ...
          <div className="mx-auto w-full max-w-96 pt-1 pr-0 lg:mx-0 lg:justify-self-start lg:-ml-40">
            <div className="relative mx-auto h-96 w-105 origin-center translate-x-0 scale-100 lg:scale-115">
